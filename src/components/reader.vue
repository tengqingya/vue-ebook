...
*
* @author tengqingya
* @create 2017-06-2017/6/10 15:33
*/
<template>
  <!--根元素-->
  <div id="root" class="container" :style="backgroud_color">
    <!--用于唤出的层，响应文章内的样式-->
    <div class="m-artical-action">
      <div class="artical-action-mid" id="action_mid" @click="action_mid">

      </div>
    </div>
    <div id="top-nav" class="top-nav" :class="topNavShow" @click="click_back">
    ...
    <!--正文-->
    <div id="fiction_container" class="m-read-content" :style="fontSize">
      <h1>序章</h1>
      <p>自古以来，凡人无不有一死。但世人皆恶死爱生，更有地府阎罗之说，平添了几分苦惧，在此之下，遂有长生不死之说。当长生不死看起来那般遥远而不可捉摸，修炼中所带来的力量，便逐渐成了许多人的目标。</p>
      <p>自古以来，凡人无不有一死。但世人皆恶死爱生，更有地府阎罗之说，平添了几分苦惧，在此之下，遂有长生不死之说。当长生不死看起来那般遥远而不可捉摸，修炼中所带来的力量，便逐渐成了许多人的目标。</p>
      <p>自古以来，凡人无不有一死。但世人皆恶死爱生，更有地府阎罗之说，平添了几分苦惧，在此之下，遂有长生不死之说。当长生不死看起来那般遥远而不可捉摸，修炼中所带来的力量，便逐渐成了许多人的目标。</p>
      <p>自古以来，凡人无不有一死。但世人皆恶死爱生，更有地府阎罗之说，平添了几分苦惧，在此之下，遂有长生不死之说。当长生不死看起来那般遥远而不可捉摸，修炼中所带来的力量，便逐渐成了许多人的目标。</p>
      <p>方今之世，正道大昌，邪魔退避。中原大地山灵水秀，人气鼎盛，物产丰富，为正派诸家牢牢占据。其中尤以“青云门”、“天音寺”、和“焚香谷”为三大支柱，是为领袖。</p>
      <p>自古以来，凡人无不有一死。但世人皆恶死爱生，更有地府阎罗之说，平添了几分苦惧，在此之下，遂有长生不死之说。当长生不死看起来那般遥远而不可捉摸，修炼中所带来的力量，便逐渐成了许多人的目标。</p>
      <p>自古以来，凡人无不有一死。但世人皆恶死爱生，更有地府阎罗之说，平添了几分苦惧，在此之下，遂有长生不死之说。当长生不死看起来那般遥远而不可捉摸，修炼中所带来的力量，便逐渐成了许多人的目标。</p>
      <p>自古以来，凡人无不有一死。但世人皆恶死爱生，更有地府阎罗之说，平添了几分苦惧，在此之下，遂有长生不死之说。当长生不死看起来那般遥远而不可捉摸，修炼中所带来的力量，便逐渐成了许多人的目标。</p>
      <p>自古以来，凡人无不有一死。但世人皆恶死爱生，更有地府阎罗之说，平添了几分苦惧，在此之下，遂有长生不死之说。当长生不死看起来那般遥远而不可捉摸，修炼中所带来的力量，便逐渐成了许多人的目标。</p>
    ...
    <div class="nav-panel" id="font-container" :class="navPanelShow">
      <div class="child-mod">
        <span>字号</span>
        <button id="large-font" class="font-size-button" @click="increse">大</button>
        <button id="small-font" class="font-size-button" @click="decrese">小</button>
      </div>
      <div class="child-mod">
        <span>背景</span>
        <div class="bk-container" v-for="(i,j) in bcColors" :key="j" @click="changeBackColor(j)">
          <div class="bk-container-current" :class="showBcColorCurrent[j]"></div>
        </div>
      </div>
    </div>
    <div id="bottom-nav" class="bottom-nav" :class="topNavShow">
      <div class="item">
        <div class="category">
      ...
      <div class="item">
        <div class="font" id="font-button" @click="font_button">
          <div class="icon-font"></div>
          <div class="icon-text">字体</div>
        </div>
      </div>
      <div class="item" id="night-button">
        <div class="day active" @click="day" v-if="showDayButton">
          <div class="icon-day"></div>
          <div class="icon-text">白天</div>
        </div>
        <div class="night active" v-else @click="night">
...
<script>
    export default {
        ...
        methods: {
          ...
          action_mid:function () {
            this.topNavShow.showNone = !this.topNavShow.showNone
            this.navPanelShow.showNone = true
          },
          font_button:function () {
            this.navPanelShow.showNone = !this.navPanelShow.showNone
          },
          day:function(){
            this.showBcColorCurrent.map(function (i, j) {
              i.activeBcButton = false
            })
            this.backgroud_color.background = "#e9dfc7"
            this.showDayButton = false
            this.showBcColorCurrent[0].activeBcButton = true
          },
          night:function () {
            this.showBcColorCurrent.map(function (i, j) {
              i.activeBcButton = false
            })
            this.backgroud_color.background = "#000"
            this.showDayButton = true
            this.showBcColorCurrent[4].activeBcButton = true
          },
          changeBackColor:function (i) {
            this.backgroud_color.background =this.bcColors[i]
            this.showBcColorCurrent.map(function (i, j) {
              i.activeBcButton = false
            })
            this.showBcColorCurrent[i].activeBcButton = true
            if(i === 4){
              this.showDayButton = true
            }
            if(i === 0){
          ...
          increse:function () {
            if (this.fontSizeNumber >22) {
              return;
            }
            this.fontSizeNumber++
          },
          decrese:function () {
            if (this.fontSizeNumber < 12) {
              return;
            }
            this.fontSizeNumber--
          }
        ...
        created: function () {
          this.bcColors = ["#e9dfc7","#a4a4a4","#cdefce","#283548","#000"]
          window.onscroll = ()=>{
            this.topNavShow.showNone = true
            this.navPanelShow.showNone = true
          }
        },
        watch: {},
      computed:{
        fontSize(){
            return "font-size:"+this.fontSizeNumber+"px"
        }
      }
    }
</script>
...
<style scoped>
  ...
  .icon-back {
    ...
    /*background-size需要在指定background之后设置*/
    /*字体图标也可以，css书写*/
  ...
  .active .bk-container-current {
    display: block;
  }
  .bk-container .activeBcButton{
    display: block;
  }
